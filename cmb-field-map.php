...
class PW_CMB2_Field_Google_Maps
{
                ...
                */
                ...
                {
                                add_filter('cmb2_render_pw_map', array(
                                                $this,
                                                'render_pw_map'
                                ), 10, 5);
                                add_filter('cmb2_sanitize_pw_map', array(
                                                $this,
                                                'sanitize_pw_map'
                                ), 10, 4);
                                add_filter('pw_google_api_key', array(
                                                $this,
                                                'google_api_key_constant'
                                ));
                }
                /**
                ...
                */
                public function render_pw_map($field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object)
                {
                                ...
                                echo '<input type="text" class="large-text pw-map-search" id="' . $field->args('id') . '" placeholder="Cerca un indirizzo o impostalo sulla mappa" />';
                                ...
                                echo $field_type_object->input(array(
                                                ...
                                                'class' => 'large-text pw-map-formatted_address',
                                                'style' => 'margin-left:0;',
                ...
                */
                public function setup_admin_scripts($api_key)
                {
                                ...
                                wp_enqueue_script('pw-google-maps', plugins_url('js/script.js', __FILE__), array(
                                                'pw-google-maps-api',
                                                'jquery'
                                ), self::VERSION);
